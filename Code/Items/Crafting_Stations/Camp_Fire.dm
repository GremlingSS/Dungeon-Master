/mob/WorkShops/CampFires
	name = "Camp Fire"

/mob/WorkShops/CampFires/GoodAltar
	name = "Holy Altar"
	icon = 'Cave.dmi'
...
/mob/WorkShops/CampFires/GoodAltar/DblClick()
...
/mob/WorkShops/CampFires/EvilAltar
	name = "Unholy Altar"
	icon = 'Cave.dmi'
...
/mob/WorkShops/CampFires/EvilAltar/DblClick()
	for(var/mob/Monsters/M in usr.Selected)
		if(M in view(1,src))
			var/list/menu = new()
			menu += "Sacrifice"
...
/mob/WorkShops/CampFires/New()
	Heat()

/mob/WorkShops/CampFires/Fire/DblClick()
	for(var/mob/Monsters/M in usr.Selected)
		if(M.Race == "Spider")
			return
		if(M.Wagon == 1)
